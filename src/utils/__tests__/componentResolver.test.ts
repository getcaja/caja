...
function makeBox(id: string, children: Frame[] = []): BoxElement {
  return {
    ...
    borderWidth: { mode: 'token', token: '0', value: 0 },
    borderColor: { mode: 'custom', value: '' },
    overflow: 'visible',
    opacity: { mode: 'token', token: '100', value: 1 },
    width: { mode: 'default' },
    height: { mode: 'default' },
    minWidth: { mode: 'default' },
    maxWidth: { mode: 'default' },
    minHeight: { mode: 'default' },
    maxHeight: { mode: 'default' },
  }
}
