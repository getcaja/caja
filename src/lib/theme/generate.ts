...
export function deriveTokens(theme: CajaTheme): ThemeTokens {
  ...
  if (theme.dark) {
    return {
      ...
      'surface-1': surface.lift(0.04).css(),
      'surface-2': surface.lift(0.09).css(),
      'surface-3': surface.lift(0.17).css(),
      'text-primary': text.css(),
      'text-secondary': text.lower(0.36).css(),
      'text-muted': text.lower(0.58).css(),
      border: surface.lift(0.065).css(),
      'border-accent': surface.lift(0.12).css(),
      accent: accent.css(),
