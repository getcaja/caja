...
export const INPUT_CLASS = 'flex-1 h-5 bg-inset border border-transparent rounded px-1 text-[12px] fg-default outline-none focus:border-accent min-w-0 transition-colors'
